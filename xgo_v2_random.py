...
# Save the figure
fig.savefig('figures2/initial_ROC_rand.png')
...
fig.savefig('figures2/ROC_near.png')
plt.show()
...
if op:
    ...
    plt.grid()
    fig.savefig('figures2/optimization_rand.png')
...
ax.get_xticklabels() + ax.get_yticklabels()):
    ...
    plt.tight_layout()
    fig.savefig('figures2/Feature_importance_rand.png')
...
# Save as CSV
report_df.to_csv("data/classification_report_near_0.5_data.csv")
...
# Save as CSV
report_df.to_csv("data/classification_report_rand_0.5.csv")
...
plt.savefig("figures2/trainingcm_rand.png")
plt.show()
...
disp.plot() 
# And show it:
plt.savefig("figures2/cm_rand.png")
plt.show()
...
plt.savefig("figures2/cm2_rand.png")
plt.show()
...
f=open("data/thresholdsmoot.txt","w")
for t in thresholds:
...
plt.ylabel('True Label')
plt.title('Confusion Matrix')
plt.savefig("figures/cm3_near.png")
plt.show()
...
# Save as CSV
report_df.to_csv("data/classification_report_rand.csv")
...
xgb.plot_tree(xgb_opt, num_trees=0)
plt.savefig("figures/re_rdap_tree.png", bbox_inches="tight", dpi=300)
plt.show()
...
graph.render("figures/re_rdap_tree_large.png", format="png", cleanup=True)