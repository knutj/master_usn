...
figure_path=os.path.join(os.getcwd(), 'figures','lstm_re')
if not os.path.exists(figure_path):
    os.makedirs(figure_path)

model_path=os.path.join(os.getcwd(), 'models', 'lstm_re')
if not os.path.exists(model_path):
    os.makedirs(model_path)

data_path=os.path.join(os.getcwd(), 'data', 'lstm_re')
...
print(y_train_all_.value_counts())           # Before undersampling

rus = RandomUnderSampler(random_state=0)
#rus  = NearMiss(version=1)
X_train_all_, y_train_all_ = rus.fit_resample(X_train_all_, y_train_all_)
print("findished under sampleing")
print(y_train_all_.value_counts()) # After undersampling
